 ...
 */
class IntSortingUtilsTest {

    @Test
    void bubbleSortTest() {
        int[] list = {2, 3, 2, 5, 6, 1, -2, 3, 14, 12};
        int[] expected = {-2, 1, 2, 2, 3, 3, 5, 6, 12, 14};
        IntSortingUtils.bubbleSort(list);
    ...
    void radixSortTest() {
        ...
        IntSortingUtils.radixSort(list);
    ...
    void selectionSortTest() {
        ...
        IntSortingUtils.selectionSort(list);
    ...
    void quickSortTest() {
        ...
        IntSortingUtils.quickSort(list);
    ...
    void mergeSortTest() {
        ...
        IntSortingUtils.mergeSort(list);
